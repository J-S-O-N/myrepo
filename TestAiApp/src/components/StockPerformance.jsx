...
function StockPerformance({ userEmail, onLogout, onNavigate }) {
  ...
  // Fetch live JSE stock data from Yahoo Finance
  const fetchStockData = async () => {
    ...
    try {
      ...
      const promises = stockSymbols.map(async (symbol) => {
        try {
          ...
          return {
            ...
            open: Math.round((indicators.open[0] || currentPrice) * 100),
            high: Math.round((indicators.high[0] || currentPrice) * 100),
            low: Math.round((indicators.low[0] || currentPrice) * 100),
      ...
      const fallbackData = [
        { symbol: 'SBK', name: 'Standard Bank Group Ltd', exchange: 'JSE', price: 17850, change: 125, changePercent: 0.71, open: 17725, high: 17890, low: 17680, volume: 2456789, marketCap: 285000000000, pe: 8.45, dividendYield: 5.2, icon: '🏦' },
        { symbol: 'FSR', name: 'FirstRand Ltd', exchange: 'JSE', price: 6542, change: -34, changePercent: -0.52, open: 6576, high: 6598, low: 6520, volume: 3890456, marketCap: 368000000000, pe: 7.89, dividendYield: 5.8, icon: '🏦' },
        { symbol: 'NED', name: 'Nedbank Group Ltd', exchange: 'JSE', price: 18520, change: 95, changePercent: 0.52, open: 18425, high: 18575, low: 18380, volume: 1234567, marketCap: 83000000000, pe: 6.23, dividendYield: 6.5, icon: '🏦' },
        ...
        { symbol: 'ABG', name: 'Absa Group Ltd', exchange: 'JSE', price: 16230, change: -78, changePercent: -0.48, open: 16308, high: 16345, low: 16180, volume: 2789456, marketCap: 125000000000, pe: 7.65, dividendYield: 5.9, icon: '🏦' }
      ];
