...
router.put(
  ...
  [
    ...
    body('daily_limit').optional().toInt().isInt({ min: 0 }),
    body('monthly_limit').optional().toInt().isInt({ min: 0 }),
    body('mobile_app_limit').optional().toInt().isInt({ min: 0 }),
    body('internet_banking_limit').optional().toInt().isInt({ min: 0 }),
    body('atm_limit').optional().toInt().isInt({ min: 0 }),
